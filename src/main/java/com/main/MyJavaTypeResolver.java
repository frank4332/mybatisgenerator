...
public class MyJavaTypeResolver implements JavaTypeResolver{
    ...
    public MyJavaTypeResolver() {
        ...
        typeMap.put(1111, new JdbcTypeInformation("NVARCHAR2", //$NON-NLS-1$
                new FullyQualifiedJavaType(String.class.getName())));
    }
    ...
    public FullyQualifiedJavaType calculateJavaType(
        ...
        FullyQualifiedJavaType fullyQualifiedJavaType = jdbcTypeInformation.getFullyQualifiedJavaType();

        if (jdbcTypeInformation != null) {
            answer = fullyQualifiedJavaType;
